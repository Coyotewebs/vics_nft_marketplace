...
setIsLoadingNFT(true)
  ...
  return (
    <NFTContext.Provider value={{ nftCurrency, connectWallet, uploadToIPFS, currentAccount, createNFT, fetchNFTs, fetchMyNFTsOrCreatedNFTs, buyNFT, setIsLoadingNFT, createSale }}>
      {children}
    </NFTContext.Provider>
  );
};
